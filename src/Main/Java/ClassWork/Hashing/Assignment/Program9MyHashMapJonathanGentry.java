/*
  ...
  Create a new concrete class named MyHashMap that implements MyMap using open addressing with linear probing.
  Lines edited from the book: 57, 137, 191, 208, and 243 (Hash function)
 */

package Main.Java.ClassWork.Hashing.Assignment;

import java.util.*;

public class Program9MyHashMapJonathanGentry {
...
class MyHashMap<K, V> implements MyMap<K, V> {
    ...
    private final static float DEFAULT_MAX_LOAD_FACTOR = 0.5f; //The table size is doubled whenever the load factor exceeds the threshold ( 0.5 ).
